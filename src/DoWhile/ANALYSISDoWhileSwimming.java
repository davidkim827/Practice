 ...
 */
public class ANALYSISDoWhileSwimming {
...
// They swim for the same amount if water temperature > 79, but an iteration is done for a do while before checking conditions.
// pre test loop = do while. post test loop = while.

...
public class GraphicsDemo2 extends Canvas {
    public void paint(Graphics g) {
        ...
        g.fillArc(300, 450, 75,75, -135,135); //lady chomp pt1
        g.fillArc(300, 450, 75,75, 0,135); //lady chomp pt2
        ...
        // custom color from ColorPicker
        Color myBlue = new Color(48, 201, 252);
        g.setColor(myBlue);

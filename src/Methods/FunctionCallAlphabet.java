...
public class FunctionCallAlphabet
{
    public static void main( String[] args )
    {
        ...
        f("feather");                       // displays the word you pass it beginning with "F"
        System.out.print(g());                    // returns the word to be displayed
        h(3);                               // tell it how many times to display the word (1)
        System.out.println();

        i(12);                    // pass it any integer and it will display a word beginning with I
        ...
        n("necklace");                     // displays the word you pass it beginning with "N"
        System.out.print(o());                   // displays a word beginning with O and returns a useless value
        ...
        t("tiger");                        // displays the word you pass it beginning with "T"
        System.out.print(u());                   // returns the word to be displayed
        v(1);                              // tell it how many times to display the word (1)
        w(2);                    // pass it any integer and it will display a word beginning with W
        System.out.print(x(2));        // returns a different word depending on what you pass it (1-2)
        y();                                     // displays a word beginning with Y
        System.out.print(z(true, false)); // returns a different word depending on which two boolean values you pass it
        System.out.println();
    }
